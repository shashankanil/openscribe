...
Clean-machine macOS permission dialogs and Gatekeeper behavior require a separate installed-build acceptance check; existing permissions on a development machine do not prove that experience.
